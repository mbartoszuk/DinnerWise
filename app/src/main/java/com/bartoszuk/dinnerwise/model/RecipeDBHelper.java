...
public class RecipeDBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insert(db, "Squash-based Pizza", "A healthy twist on the regular pizza to try out something new. Customise it by adding your favourite toppings.", 90, 2,
        ...
        insert(db, "Veg and Peanut Stir-fry", "A fried vegetable mix in a sweet and spicy peanut sauce. Here, served on rice, but also tastes great on rice noodles.", 45, 2,
        ...
        insert(db, "Cauliflower Soup", "A creamy and hearty soup, that will fill you up with delicious veggies. Top up with a sour fruit, like pomegranate seeds, for the best taste.\n", 30, 3,
        ...
        insert(db, "Mini-pancakes with Nuts", "A slight-indulgent type of dinner composed of nutritious ingredients. Add your favourite toppings as preferred, we went for vanilla yoghurt and plum jam.\n", 30, 2,
        ...
        insert(db, "Very Green Smoothie", "An on-the-go dinner alternative for those busy days when there is no time to cook. Very creamy and filling, and only take minutes to prepare.\n", 10, 1,
        ...
        insert(db, "Sweet Potato Falafels", "A good portion of baked falafels gives you a healthy and filling meal. Can be eaten with a salad, a soup, or just on its own as a snack.\n", 60, 2,
        ...
        insert(db, "Lentil Casserole", "A great mix of baked vegetables and lentils. Good to prepare before a busy week, when there will not be time to cook. Stores perfectly for a week.\n", 120, 4,
        ...
        insert(db, "French Bean Pasta", "A green and whole meal take on an indulgent meal. The fresh basil makes the pesto very aromatic, making a feast for more senses.\n", 25, 2,
        ...
        insert(db, "Lazy Dumplings", "Lazy Dumplings get their name from being very quick to prepare. They are in the sweet theme, but can be a great protein-rich meal.\n", 25, 2,
        ...
        insert(db, "Veggie Sushi", "Some think that sushi is difficult to make, but in fact it is very quick and only requires few simple steps. The veggies can be replaced with any desired filling.\n", 30, 2,
        ...
        insert(db, "Lecho", "Lecho is a traditional hungarian dish that is easy to make and customise to your taste. Can be served with any type of grains or rice.\n", 60, 4,
        ...
        insert(db, "Spinach Lasagne", "Lasagne is a dish that can be made either on an indulgent side, or on a healthy side. Here is a healthy proposition of the spinach lasagne with soft ricotta cheese.", 50, 2,
        ...
        insert(db, "French Omelette", "A breakfast staple in many countries, can also serve a role of a dinner. The veggies inside can be replaced to whatever is in your fridge. Can also include ham and cheese.\n", 30, 2,
        ...
        insert(db, "Pickle-Veggie Soup", "A light vegetable soup with a pickle twist, which makes the soup taste slightly sour. A traditional recipe in the western Europe. Can also be made on chicken broth base.\n", 60, 6,
        ...
        insert(db, "Aubergine Dip", "A very aromatic and creamy dip, which is great to eat in a sandwich or tortilla, or mixed in with any type of grains and rice.", 90, 4,
